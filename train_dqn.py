...
def main():
    ...
    parser.add_argument("--env", type=int, default=0, help="Which of the 2 environment functions to use: 0 for easy, 1 for hard.")
    parser.add_argument("--reward_mode", type=str, default="default", choices=["default", "v2"], help="Reward function to use.")
